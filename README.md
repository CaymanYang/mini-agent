...
When you ask to open a file, the agent can call `open_file`. If the `code` command is available it opens the file non-blocking in VS Code/Cursor; otherwise it prints a `vim` command to run manually.
